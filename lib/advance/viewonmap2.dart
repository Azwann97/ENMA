...
class LocationMapNormal extends StatefulWidget {

  final String docId ;
  final String eventName ;

  LocationMapNormal({this.docId, this.eventName});

  @override
  _LocationMapNormalState createState() => _LocationMapNormalState();
}

class _LocationMapNormalState extends State<LocationMapNormal> {

  Map<MarkerId, Marker> markers = <MarkerId, Marker>{}; // CLASS MEMBER, MAP OF MARKS
  MapType currentMapType  = MapType.normal;   // new
