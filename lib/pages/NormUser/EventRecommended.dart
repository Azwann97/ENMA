...
class EventRecommended extends StatefulWidget{
  EventRecommended({this.uid, this.up});
  final String uid;
  final String up;
  @override
  State<StatefulWidget> createState() => new _EventRecommendedState();

}

class _EventRecommendedState extends State<EventRecommended>{
                  ...
                  children: <Widget>[
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          Expanded(
                            child: Padding(
                              padding: const EdgeInsets.symmetric(horizontal: 32.0),
                              child: Text("Recommended for You", style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white, fontSize: 30.0),),
                            ),
                          ),
                          Padding(
                            padding: const EdgeInsets.symmetric(horizontal: 32.0),
                                ...
                                child: RaisedButton.icon(
                                  ...
                                  onPressed: (){
                                    Navigator.of(context).push(new MaterialPageRoute(
                                        builder: (BuildContext context) => new userPreference(uid: widget.uid)
                                    ));
                                  },
                                  icon: Icon(Icons.add, color: Colors.white,),
                                  label: Text("Change My Preference", style: TextStyle(color: Colors.white),),
                                ),
                              ),
                            ),
                          ),
                    ...
                    Container(
                      child: Column(
                        ...
                        children: <Widget>[
                          StreamBuilder(
                            stream: Firestore.instance.collection("Registered Event").where("Event Status", isEqualTo: 'Activate').where('Date', isGreaterThanOrEqualTo: DateTime.now()).where("Event Type", isEqualTo: widget.up).orderBy("Date", descending: true).snapshots(),
