...
class Join extends StatefulWidget{
  ...
  Join({this.uid});
  @override
  State<StatefulWidget> createState() => new _JoinState();
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          Padding(
                            padding: const EdgeInsets.symmetric(horizontal: 32.0),
                            child: Text('Joined Events', style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white, fontSize: 30.0),),
                          ),
                        ],
                      ),
                    ),
                    Container(
                      child: Column(
                        ...
                        children: <Widget>[
                          StreamBuilder(
                            stream: Firestore.instance.collection("Joined Event").where("User Id", isEqualTo: widget.uid).snapshots(),
                            builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot){
                              if(!snapshot.hasData){
                                return new Container(
                                  child: Center(
                                    //child: Loading1(),
                                    child: Center(child: Text("Sorry, you have not joining any event yet")),
                                  ),
                                );
                              }
                              return Container(
                                  height: 500.0,
                                  child: new JEList(document: snapshot.data.documents)
                              );
                            },
                          ),
                        ],
...
class JEList extends StatelessWidget {
  JEList({this.document});
