...
class AllEvent extends StatefulWidget{
  @override
  State<StatefulWidget> createState() => new _AllEventState();
              ...
              children: <Widget>[
                                              ...
                                              Padding(
                                                ...
                                                child: new Row(
                                                  ...
                                                  children: <Widget>[
                                                    ...
                                                    Text(Participant, style: new TextStyle(fontSize: 20.0, letterSpacing: 1.0),)
                                                  ],
                                                ),
                                              )
                                            ],
                                    ...
                                    children: <Widget>[
                                      ...
                                      new Row(
                                        ...
                                        children: <Widget>[
                                          ...
                                          Expanded(child: Text(time, style: new TextStyle(fontSize: 20.0, letterSpacing: 1.0),))
                                        ],
                                      ),
                                      new Row(
                                        crossAxisAlignment: CrossAxisAlignment.start,
                ...
                new SizedBox(
                  ...
                  child: new IconButton (
                      icon: Icon(Icons.edit, color: Colors.black87, size: 50.0,),
                      onPressed: (){
